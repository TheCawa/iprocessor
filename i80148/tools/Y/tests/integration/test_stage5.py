#!/usr/bin/env python3
"""
Stage-5 tests: structures for the Y compiler.
"""
...
CASES_DIR = ROOT / 'i80148' / 'tools' / 'Y' / 'tests' / 'integration' / 'stage5'

TEST_CASES = [
    ('struct_basic.y', 7),
    ('struct_global.y', 30),
    ('struct_ptr.y', 15),
    ('struct_ptr_param.y', 5),
    ('struct_field_types.y', 6),
    ('struct_addr_field.y', 11),
]
...
def main():
    ...
    if all_passed:
        ...
        print("\nSome stage-5 tests failed.", file=sys.stderr)
        return 1
